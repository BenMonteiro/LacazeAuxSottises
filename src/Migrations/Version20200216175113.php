 ...
 */
final class Version20200216175113 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE performance (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, event_id INT DEFAULT NULL, city_show VARCHAR(255) NOT NULL, place_show VARCHAR(255) NOT NULL, date DATETIME NOT NULL, price DOUBLE PRECISION DEFAULT NULL, is_highlight TINYINT(1) NOT NULL, INDEX IDX_82D79681979B1AD6 (company_id), INDEX IDX_82D7968171F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
